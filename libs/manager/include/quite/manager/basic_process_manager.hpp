...
class QUITE_MANAGER_EXPORT BasicProcessManager
{
  public:
     ...
     */
    virtual Result<ProcessHandle> application(const ProcessId &name) = 0;
     ...
     */
    virtual Result<ProcessHandle> launch_application(ProcessId id,
     ...
     */
    virtual Result<std::filesystem::path> find_executable(std::filesystem::path exe_name, Environment environment) = 0;
