...
{
public:
    QThreadOperationState(Recv&& receiver, QThread* thread) : m_receiver(std::move(receiver)), m_thread(thread) {}
    void start() noexcept {
        QMetaObject::invokeMethod(m_thread->eventDispatcher(),
...
public:
    ...
    {
        oper_state.connection = QObject::connect(oper_state.m_obj, oper_state.m_ptr,
                                      [&oper_state](Args... args) {
