...
class Image:
    ...
    def __init__(self) -> None:
        ...
        2. __init__(self: quite._quite.Image, file_path: typing.Union[os.PathLike, str, bytes]) -> None
        """
    ...
    def save_to(self, file_path: os.PathLike | str | bytes) -> None:
        """save_to(self: quite._quite.Image, file_path: typing.Union[os.PathLike, str, bytes]) -> None"""
...
class Property:
    ...
    def fetch(self) -> bool | int | int | float | str | RemoteObject:
        """fetch(self: quite._quite.Property) -> typing.Union[bool, int, int, float, str, quite._quite.RemoteObject]"""

    def value(self) -> bool | int | int | float | str | RemoteObject:
        """value(self: quite._quite.Property) -> typing.Union[bool, int, int, float, str, quite._quite.RemoteObject]"""
    ...
    def wait_for_value(
        ...
        """wait_for_value(self: quite._quite.Property, target_value: typing.Union[bool, typing.SupportsInt, typing.SupportsInt, typing.SupportsFloat, str, quite._quite.RemoteObject], timeout: datetime.timedelta) -> typing.Union[bool, int, int, float, str, quite._quite.RemoteObject]"""
