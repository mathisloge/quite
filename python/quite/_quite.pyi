...
class ObjectQueryBuilder:
    ...
    def with_property(self, key: str, value: typing.SupportsInt) -> ObjectQueryBuilder:
        ...
        """
    @overload
    def with_property(self, key: str, value: typing.SupportsFloat) -> ObjectQueryBuilder:
        """with_property(*args, **kwargs)
        Overloaded function.
...
class Property:
    ...
    def wait_for_value(self, target_value: bool | typing.SupportsInt | typing.SupportsInt | typing.SupportsFloat | str | RemoteObject, timeout: datetime.timedelta) -> bool | int | int | float | str | RemoteObject:
    ...
    def write(self, value: bool | typing.SupportsInt | typing.SupportsInt | typing.SupportsFloat | str | RemoteObject) -> None:
