...
class ObjectQueryBuilder:
    ...
    @overload
    def property(self, key: str, value: typing.SupportsInt | typing.SupportsIndex) -> ObjectQueryBuilder:
        ...
        """
    @overload
    def property(self, key: str, value: typing.SupportsFloat | typing.SupportsIndex) -> ObjectQueryBuilder:
        """property(*args, **kwargs)
        Overloaded function.
...
class Probe:
    ...
    def find_object(self, object_query) -> RemoteObject:
        ...
        """
    def try_find_object(self, object_query, timeout: datetime.timedelta) -> RemoteObject:
...
class ProbeManager:
    ...
    def launch_qt_probe_application(self, name: str, path_to_application: str, args: collections.abc.Sequence[str] = ...) -> Probe:
...
class Property:
    ...
    def wait_for_value(self, target_value: bool | typing.SupportsInt | typing.SupportsIndex | typing.SupportsInt | typing.SupportsIndex | typing.SupportsFloat | typing.SupportsIndex | str | RemoteObject, timeout: datetime.timedelta) -> bool | int | int | float | str | RemoteObject:
    ...
    def write(self, value: bool | typing.SupportsInt | typing.SupportsIndex | typing.SupportsInt | typing.SupportsIndex | typing.SupportsFloat | typing.SupportsIndex | str | RemoteObject) -> None:
...
class RemoteObject:
    ...
    def __init__(self, *args, **kwargs) -> None:
        """Initialize self.  See help(type(self)) for accurate signature."""
    def invoke(self, method: str, parameters: collections.abc.Sequence[bool | typing.SupportsInt | typing.SupportsIndex | typing.SupportsInt | typing.SupportsIndex | typing.SupportsFloat | typing.SupportsIndex | str | RemoteObject] = ...) -> bool | int | int | float | str | RemoteObject:
